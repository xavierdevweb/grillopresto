<div class="text-center my-5">
    <button type="button" id="btnCloseTicket" class="btn btn-primary btn-rounded btn-scale-press w-75"
        data-bs-toggle="modal" data-bs-target="#expiredTicketModal">
        Ce ticket est expiré
    </button>
</div>
<div class="modal fade" id="expiredTicketModal" tabindex="-1" aria-labelledby="expiredTicketModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered m-auto px-2">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Changer le status du ticket:
            ...
            <div class="modal-body d-flex flex-column align-items-center">
                ...
                <p class="fs-5 fw-bold text-center">Le status du ticket sera:<span class="text-danger"> Expiré</span>
                </p>
